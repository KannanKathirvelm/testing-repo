...
@Component({
  selector: 'interactive-resource',
  templateUrl: './interactive-resource.component.html',
  styleUrls: ['./interactive-resource.component.scss'],
  animations: [collapseAnimation({ duration: 500, delay: 0 })]
})
export class InteractiveResourceComponent implements OnInit {
  // -------------------------------------------------------------------------
  // Properties
