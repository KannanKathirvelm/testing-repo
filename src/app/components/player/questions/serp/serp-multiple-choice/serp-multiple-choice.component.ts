...
@Component({
  selector: 'serp-multiple-choice',
  templateUrl: './serp-multiple-choice.component.html',
  styleUrls: ['./serp-multiple-choice.component.scss'],
  animations: [collapseAnimation({ duration: 500, delay: 0 }), fadeAnimation]
})
export class SerpMultipleChoiceComponent implements OnInit {
