...
// SERP Questions
import { ComprehensionComponent } from '@components/player/questions/serp/comprehension/comprehension.component';
...
export const QUESTION_TYPES = {
  ...
  serp_lang_activities_for_comprehension_question: ComprehensionComponent,
