...
@Component({
  selector: 'multiple-select-text',
  templateUrl: './multiple-select-text.component.html',
  styleUrls: ['./multiple-select-text.component.scss'],
  animations: [collapseAnimation({ duration: 500, delay: 0 }), fadeAnimation]
})
export class MultipleSelectTextComponent implements OnInit {
