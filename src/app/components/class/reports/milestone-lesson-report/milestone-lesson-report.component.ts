...
export class MilestoneLessonReportComponent implements OnInit {
  ...
  public getMilestonePerformance() {
    ...
    this.scoreInPercentage = this.lesson.performance && this.lesson.performance.averageScore !== null ?
      this.lesson.performance.averageScore : null;
